...
<header class="bg-gradient-to-r {hdr} text-white shadow-lg">
  <div class="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-5 flex flex-row items-center gap-3">
    <div class="flex-1 min-w-0">
      ...
      <div class="text-xs text-blue-300 mt-0.5 hidden sm:block">整合：發表著作 · 國科會計畫 · 教學實踐計畫 · 教師歷程</div>
    </div>
...
<footer class="text-xs text-slate-500 py-6 border-t border-slate-200 mb-20">
  <div class="max-w-7xl mx-auto px-3 sm:px-4">
    <div class="font-medium text-slate-600 mb-2">📚 資料來源（每週一 01:00 Taipei 自動更新）</div>
    <ul class="space-y-1 ml-5 list-disc">
      ...
      <li>教師歷程、當學期課表：<a href="{cfg['dept_list_url']}" target="_blank" class="text-blue-500 hover:underline">淡江大學教師歷程系統</a></li>
    </ul>
  </div>
</footer>
