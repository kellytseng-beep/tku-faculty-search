...
{cards_html}
  ...
  <div class="mt-10 bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
    ...
    <p class="text-sm text-slate-500 leading-relaxed">
      本查詢系統整合三個系所的專任師資資料，著作資料來源為
      <a href="https://nscpeople.onrender.com/" target="_blank" class="text-blue-500 hover:underline">國科會研究人才資料庫</a>，
      教師歷程連結至
      <a href="https://teacher.tku.edu.tw/" target="_blank" class="text-blue-500 hover:underline">淡江大學教師歷程系統</a>。
      支援依姓名、論著關鍵字搜尋，以及依職稱、研究領域篩選。
    </p>
  </div>
</main>
